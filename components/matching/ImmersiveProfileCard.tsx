    ...
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.stickyHeader, { opacity: headerOpacity }]}>
        <BlurView intensity={90} tint="light" style={styles.headerBlur}>
          <SafeAreaView edges={['top']} style={styles.headerContent}>
            <Image source={{ uri: heroPhoto }} style={styles.headerAvatar} />
      ...
      >
        ...
        <View style={styles.content}>
          ...
          {/* Photo 2 */}
          {photos[1] && (
            <Image source={{ uri: photos[1].url }} style={styles.storyPhoto} resizeMode="cover" />
          )}
          ...
          {profile.prompt_answers?.[0] && (
            <View style={styles.promptPhotoSection}>
              ...
              {photos[2] && (
                <Image source={{ uri: photos[2].url }} style={styles.promptPhoto} resizeMode="cover" />
              )}
            </View>
          )}
          ...
          {/* Photo 4 */}
          {photos[3] && (
            <Image source={{ uri: photos[3].url }} style={styles.storyPhoto} resizeMode="cover" />
          )}
          ...
          {profile.prompt_answers?.slice(1).map((prompt, index) => (
            <View key={index} style={styles.promptPhotoSection}>
              ...
              {photos[4 + index] && (
                <Image source={{ uri: photos[4 + index].url }} style={styles.promptPhoto} resizeMode="cover" />
              )}
            </View>
          ))}
          ...
          {photos.slice(5).map((photo, index) => (
            <Image key={index} source={{ uri: photo.url }} style={styles.storyPhoto} resizeMode="cover" />
          ))}
